<?php
// หน้า dashboard ของ user (ปรับปรุง UI ให้เหมือน Admin)
session_start();
...
<head>
    ...
    <title>MaintDash - User Dashboard</title>
...
<body>
    <!-- เรียกใช้ Sidebar User ที่ปรับปรุงแล้ว -->
        ...
        <div class="dashboard-content-wrapper">
            ...
            <div class="row g-3 mb-4">
                <div class="col-12 col-sm-6 col-xl-3">
                    <div class="stats-card card-primitive" onclick="location.href='pmproject_user.php'"
                ...
                <div class="col-12 col-sm-6 col-xl-3">
                    <div class="stats-card card-service" onclick="location.href='service_user.php'"
                        style="cursor: pointer;">
                        <div class="stats-card-info">
                            <p>Service</p>
                ...
                <div class="col-12 col-sm-6 col-xl-3">
                    <div class="stats-card card-product" onclick="location.href='product_user.php'" style="cursor: pointer;">
                        <div class="stats-card-info">
                            <p>Product Claim</p>
                ...
                <div class="col-12 col-sm-6 col-xl-3">
                    <div class="stats-card card-customer" onclick="location.href='customers_user.php'"
                        style="cursor: pointer;">
                        <div class="stats-card-info">
                            <p>Customers</p>
                ...
                <div class="col-12">
                    <div class="stats-card card-white p-4 h-100">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <a href="pmproject_user.php" class="btn btn-sm btn-outline-primary rounded-pill px-3">
