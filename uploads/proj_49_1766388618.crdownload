...
--
-- Host: localhost:3304
-- Generation Time: Dec 19, 2025 at 02:52 AM
...
(32, 'บจก. ไชโยโอ้เอ้ (เน้นอู้ ไม่เน้นงาน)', 'วิจัยฝุ่นและสิ่งแวดล้อม', 'ชัยจัญไร', '12121', 'ตึกแถวสภาพร่อแร่ ซอยเงินเดือนหมดตั้งแต่วันที่ 5 เขตยากจน', 'จ. ประจัญบาน (เน้นบวก ไม่เน้นคุย)'),
(33, 'กอง: พัฒนาการนอนหลับในเวลาราชการ', 'วิจัยอาหารกลางวันและร้านส้มตำ', 'ชัย ไส้ศึก', '89988998', '44 ชั้น 4 ห้องริมสุดที่แอร์เสียน้ำไม่ไหล', 'จ. แพร่ (แพร่กระจายไปทั่ว... โดยเฉพาะความจัญไร)'),
(34, 'กุมารชัย จำกัด', 'แปดปลั๊ก', 'ชัย ส้นตีนนิ่ง', '11111111', 'เลขที่ 0/0: ใต้สะพานลอยที่ไฟกระพริบๆ', 'เลย'),
(35, 'บจก. ไชโยโอ้เอ้ (เน้นอู้ ไม่เน้นงาน)', 'หัวหน้ากอง: ปราบปรามความเจริญ', 'ชัย อมขี้', '044', 'กทม', 'สเร็นถิ่นจูน');
...
(34, 'ซื้อแบตเตอรี่ลิเทียมขนาด 48V/100 Ah และ Rectifier พร้อมการติดตั้ง สำหรับ สค.ในพื้นที่ ภน.1', 9, '-', 'In Progress', 'PJ6711008', 'แบต 5 ปี /Rectifier 2 ปี', 'รับประกัน ไม่มี MA', 'uploads/proj_34_1765955754.jpg', '2025-09-08', '2030-09-08'),
(39, 'เชิญร่วมงานเเต่งงาน จูน 👨‍❤️‍💋‍👨 เอ็ม', 8, 'ดร.หมอดู ดูหม้อสุรินทร์', 'In Progress', 'PJ660315151', '1 ปี', '', 'uploads/proj_39_1765964999.jpg', '2024-12-15', '2025-12-15'),
(40, 'จูนนี่ลา เอ็มลา', 8, 'เอ็มจูน คู่หูมหาประลัย', 'In Progress', '48963588555', '1', 'เช็คระยะหลังกินต้มทุกๆ1เดือน', 'uploads/proj_40_1766052360.jpg', '2024-12-16', '2025-12-16');
...
INSERT INTO `product` (`product_id`, `customers_id`, `address`, `repair_details`, `phone`, `device_name`, `serial_number`, `file_path`) VALUES
(17, 9, '99 ถนนแจ้งวัฒนะ แขวงทุ่งสองห้อง เขตหลักสี่ กรุงเทพฯ 10210.', 'หน้าจอแสดงผลมีเส้นลายรบกวน และปุ่มกดตอบสนองช้า', '0898756465', 'Philips Patient Monitor', 'PH-PM-223344', NULL),
(19, 9, '99 ถนนแจ้งวัฒนะ แขวงทุ่งสองห้อง เขตหลักสี่ กรุงเทพฯ 10210.', 'เปิดเครื่องไม่ติด (No Power) ไฟสถานะชาร์จไม่ขึ้น', '0898756465', 'Lenovo ThinkPad X1 Carbon', 'NB-LNV-445566', NULL),
(22, 9, '99 ถนนแจ้งวัฒนะ แขวงทุ่งสองห้อง เขตหลักสี่ กรุงเทพฯ 10210.', 'กระดาษติด (Paper Jam) บ่อยครั้ง และพิมพ์ออกมามีรอยเปื้อนหมึก', '0898756465', 'HP LaserJet Pro M404dn', 'PR-HP-667788', 'uploads/prod_1766041820_3723.docx');
...
(5, 8, 'โครงการจัดซื้ออุปกรณ์สนับสนุนปฏิบัติหน้าที่ DSI', 'Server Dell R740', 'กล้องไม่สามารถไฟล์ภาพสดกลับมาที่ส่วนกลางได้', 'เรียบร้อยดี', 'Subcontractor', '2025-11-04', '2025-10-04', 'doc_5_1766033482.jpg', '2025-12-12 02:18:18'),
(6, 9, 'จ้างเหมาติดตั้งแบตเตอรี่ 14 ภน.', ' 1.RN2310124810023112700007 2.RN2310124810023112700034', 'แบตเตอรี่ไม่สามารถสำรองไฟได้ ทำให้อุปกรณ์ภายในชุมสายดับเป็นเวลา 30 นาที', 'เปลี่ยนแบตเตอรี่เรียบร้อย', 'Remote', '2024-11-27', '2024-12-03', NULL, '2025-12-12 06:16:34'),
...
(8, 14, 'โทรศัพท์', 'IP PHONE C62GP \"DINSTAR\"', 'ตัว Zycoo เเละ ATA ที่โทรศัพท์เชื่อมต่ออยู่ Error', 'รีบูตตัว Zycoo เเละ ATA เเละเซ็ตค่าโทรศัพท์ใหม่', 'Remote', '2025-05-05', '2025-05-05', 'doc_8_1766033785.jpg', '2025-12-16 04:21:01'),
...
--
ALTER TABLE `customers`
  MODIFY `customers_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT for table `ma_schedule`
--
ALTER TABLE `ma_schedule`
  MODIFY `ma_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=106;
