...
<style>
    ...
    :root { --sidebar-width: 250px; --toggle-btn-color: #2962ff; --sidebar-bg: #fff; --sidebar-item-height: 48px; }
    ...
    .nav-menu li a { display: flex; align-items: center; min-height: var(--sidebar-item-height); gap: 12px; padding: 12px 16px; color: #555; text-decoration: none; font-weight: 500; border-left: 4px solid transparent; border-radius: 12px; line-height: 1.2; }
    ...
    .nav-menu li a i:first-child { width: 22px; min-width: 22px; text-align: center; font-size: 1rem; }
    ...
    .logout-link { display: flex; align-items: center; min-height: var(--sidebar-item-height); gap: 12px; padding: 12px 16px; border-radius: 12px; }
    .logout-link i { width: 22px; min-width: 22px; text-align: center; }
